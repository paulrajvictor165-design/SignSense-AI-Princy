...
class CurrencyService:
    ...
    def _detect_with_gemini(self, image_bytes: bytes) -> dict:
        ...
        """
        prompt = (
    "You are an expert at identifying Indian Rupee banknotes. "
    "Analyze the uploaded image carefully. "
    "Look at the denomination number, RBI text, Mahatma Gandhi portrait, "
    "note color, security strip, serial number area, and overall design. "
    "Choose ONLY one valid denomination from: 10, 20, 50, 100, 200, 500, 2000. "
    "If the image is blurry, folded, partially visible, dark, or not an Indian currency note, "
    "reply only with 'unknown'. "
    "Verify your answer twice before responding. If you are not highly certain, reply only with 'unknown'. "
    "Return ONLY the denomination number. "
    "Do not return any explanation, sentence, currency symbol, or extra text."
)
